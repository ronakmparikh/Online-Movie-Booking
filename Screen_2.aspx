<%@ Page Title="" Language="C#" MasterPageFile="~/User_Master.master" AutoEventWireup="true" CodeFile="Screen_2.aspx.cs" Inherits="Screen_1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:DataList OnItemCommand="hi" ID="DataList1" runat="server" 
            HorizontalAlign="Center" RepeatColumns="3" Visible="False">
            <ItemTemplate>
                <table style="width:100%;">
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td style="width: 112px">
                            &nbsp;</td>
                        <td>
                            <asp:Button ID="Button1"  CommandName="thisisbook" 
                                CommandArgument='<%# Eval("movieid") %>' runat="server" Text="Book Tickets" 
                                onclick="Button1_Click" BackColor="Gray" 
                    BorderColor="Black" ForeColor="White"/>
                        </td>
                    </tr>
                    <tr>
