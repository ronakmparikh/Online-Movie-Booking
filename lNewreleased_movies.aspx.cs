...
public partial class Newreleased_movies : System.Web.UI.Page
{
    ...
    public void hi(object sender, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "lreleasedetail")
        {
            Session["nrm"] = i;

            Response.Redirect("lNewreleased_detail.aspx");
        }
    }
