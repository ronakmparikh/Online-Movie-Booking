<%@ Page Title="" Language="C#" MasterPageFile="~/User_Master.master" AutoEventWireup="true" CodeFile="Screen_1.aspx.cs" Inherits="Screen_1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:DataList OnItemCommand="hi" ID="DataList1" runat="server" 
            HorizontalAlign="Center" RepeatColumns="3" Visible="False" Width="793px">
            <ItemTemplate>
                <table style="width:100%;">
                    <tr>
                        <td colspan="2">
