<%@ Page Title="" Language="C#" MasterPageFile="~/LogoutMaster.master" AutoEventWireup="true" CodeFile="lContactus.aspx.cs" Inherits="Contactus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%;">
        <tr>
            <td style="width: 406px; " rowspan="7">
            </td>
            <td style="height: 33px" align="center" colspan="4">
                <img alt="" src="images/feedback-icon.png" /></td>
            <td class="h60" rowspan="7">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 1165px; height: 19px">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="TextBox5" ErrorMessage="Give valid Email" 
